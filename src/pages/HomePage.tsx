        ...
        <div className="space-y-8 sm:space-y-10">
          <Section className="relative z-10">
            <ProfileCard
              ...
              description={`I help teams grow, deliver value, and thrive by building great 
                software and stronger human connections. Currently seeking new opportunities.`}
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <NavCard
                  title="Mentoring"
                  href="/mentoring"
                  description="Limited free mentoring sessions to discuss challenges, growth, or career decisions."
                />
                <NavCard
                  title="Contact"
                  href="/contact"
